...
g_options::graph_options = graph_options(
    n_nodes = [10, 30, 50, 100, 250, 500, 750, 1000, 1250, 1500, 1750, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000, 1000000],  # 10, 30, 50, 100, 250, 500, 750, 1000, 1250, 1500, 1750, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000, 1000000
    tree_ids = [
        "Rectangle_quad",
        # "Rectangle_trio",
    ],
...
if sim_options.benchmark
    ...
    create_benchmarked_simulations(
        g_options = g_options,
